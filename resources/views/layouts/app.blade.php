...
<head>
    ...
    <title>@yield('title', 'App Shop'){{-- config('app.name', 'Laravel') --}}</title>
    ...
    <nav class="navbar navbar-transparent  navbar-absolute">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">{{ __('APP Shop') }}</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="navbarDropdown" class="btn btn-simple dropdown-toggle" href="#" role="button"
