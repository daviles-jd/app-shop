...
@section('content')
    ...
    <div class="main main-raised">
        <div class="container">
            <div class="section">
                <h2 class="title text-center">{{ __('Registrar nuevo producto') }}</h2>
                ...
                <form method="post" action="{{ url('/admin/products') }}">
                    ...
                    <div class="form-group label-floating">
                        <label class="control-label">{{ __('Descripción corta') }}</label>
                        <input type="text" class="form-control" name="description" value="{{ old('description') }}">
                    </div>

                    <textarea class="form-control" placeholder="{{ __('Descripción extensa del producto') }}" rows="5"
                        name="long_description">{{ old('long_description') }}</textarea>
                    <button class="btn btn-primary">{{ __('Registrar producto') }}</button>
