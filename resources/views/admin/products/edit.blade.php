        ...
        <div class="section">
            ...
            <form method="post" action="{{ url('/admin/products/'.$product->id.'/edit') }}">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" placeholder="{{ __('Descripción extensa del producto') }}" rows="5" name="long_description">{{ old('long_description',$product->long_description) }}</textarea>
